...
const team = [
  ...
  },
  {
    ...
    bio: "Oversees all technical aspects of construction — from structural design to quality control. Ensures every build meets engineering standards and safety codes.",
